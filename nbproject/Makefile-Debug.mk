...
${OBJECTDIR}/capture.o: capture.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/capture.o capture.c

${OBJECTDIR}/common/PID.o: common/PID.c
	${MKDIR} -p ${OBJECTDIR}/common
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/common/PID.o common/PID.c

${OBJECTDIR}/common/action.o: common/action.c
	${MKDIR} -p ${OBJECTDIR}/common
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/common/action.o common/action.c

${OBJECTDIR}/common/comutil.o: common/comutil.c
	${MKDIR} -p ${OBJECTDIR}/common
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/common/comutil.o common/comutil.c

${OBJECTDIR}/common/delay.o: common/delay.s
	${MKDIR} -p ${OBJECTDIR}/common
	$(AS) $(ASFLAGS) -g -o ${OBJECTDIR}/common/delay.o common/delay.s

${OBJECTDIR}/common/linetrace.o: common/linetrace.c
	${MKDIR} -p ${OBJECTDIR}/common
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/common/linetrace.o common/linetrace.c

${OBJECTDIR}/common/motor.o: common/motor.c
	${MKDIR} -p ${OBJECTDIR}/common
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/common/motor.o common/motor.c

${OBJECTDIR}/common/music/music.o: common/music/music.c
	${MKDIR} -p ${OBJECTDIR}/common/music
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/common/music/music.o common/music/music.c

${OBJECTDIR}/common/music/sub.o: common/music/sub.c
	${MKDIR} -p ${OBJECTDIR}/common/music
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/common/music/sub.o common/music/sub.c

${OBJECTDIR}/common/position.o: common/position.c
	${MKDIR} -p ${OBJECTDIR}/common
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/common/position.o common/position.c

${OBJECTDIR}/common/sensor.o: common/sensor.c
	${MKDIR} -p ${OBJECTDIR}/common
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/common/sensor.o common/sensor.c

${OBJECTDIR}/common/servo.o: common/servo.c
	${MKDIR} -p ${OBJECTDIR}/common
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/common/servo.o common/servo.c

${OBJECTDIR}/common/stm32f10x_it.o: common/stm32f10x_it.c
	${MKDIR} -p ${OBJECTDIR}/common
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/common/stm32f10x_it.o common/stm32f10x_it.c

${OBJECTDIR}/common/syscalls.o: common/syscalls.c
	${MKDIR} -p ${OBJECTDIR}/common
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/common/syscalls.o common/syscalls.c

${OBJECTDIR}/common/system_stm32f10x.o: common/system_stm32f10x.c
	${MKDIR} -p ${OBJECTDIR}/common
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/common/system_stm32f10x.o common/system_stm32f10x.c

${OBJECTDIR}/common/tof/VL53L0X.o: common/tof/VL53L0X.c
	${MKDIR} -p ${OBJECTDIR}/common/tof
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/common/tof/VL53L0X.o common/tof/VL53L0X.c

${OBJECTDIR}/common/utility.o: common/utility.c
	${MKDIR} -p ${OBJECTDIR}/common
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/common/utility.o common/utility.c

${OBJECTDIR}/common/xbee.o: common/xbee.c
	${MKDIR} -p ${OBJECTDIR}/common
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/common/xbee.o common/xbee.c
...
${OBJECTDIR}/mode.o: mode.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/mode.o mode.c

${OBJECTDIR}/setup.o: setup.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/setup.o setup.c

${OBJECTDIR}/subroutine.o: subroutine.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/subroutine.o subroutine.c
